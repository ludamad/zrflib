...
export class GameState {
    ...
    public setPiece(cell:GraphNode, player:Player, piece:Piece):void {
        ...
        this._enumAttributes[cell.enumId] = piece.startingAttributes || 0;
    }
...
export class GameStateDescriptor {
    ...
    public createGameState():GameState {
        let {_enumOwners, _enumPieces, _enumStackAmounts, _enumAttributes} = this._initialState;
        return new GameState(this, arrayCopy(_enumOwners), arrayCopy(_enumPieces), arrayCopy(_enumAttributes), arrayCopy(_enumStackAmounts));
    }
}
